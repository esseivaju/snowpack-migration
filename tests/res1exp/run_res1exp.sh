...
PREC="1e-3"
numdiff -r ${PREC} output_ref/MST96_res.haz output/MST96_res.haz
numdiff -r ${PREC} output_ref/MST96_res.ini output/MST96_res.ini
numdiff -r ${PREC} output_ref/MST96_res.sno output/MST96_res.sno
...
numdiff -r ${PREC} --speed-large-files output_ref/MST96_res.met output/MST96_res.met
rm -f output_ref/MST96_res.met
...
numdiff -r ${PREC} --speed-large-files output_ref/MST96_res.pro output/MST96_res.pro
rm -f output_ref/MST96_res.pro
