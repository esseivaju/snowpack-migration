...
numdiff -r ${PREC} --speed-large-files output_ref/MST96_res.met output/MST96_res.met | grep "+++"
rm -f output_ref/MST96_res.met
...
numdiff -r ${PREC} --speed-large-files output_ref/MST96_res.pro output/MST96_res.pro | grep "+++"
rm -f output_ref/MST96_res.pro
