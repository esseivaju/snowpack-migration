                                   ...
                                   PositionSun& Psolar, RadiationData& Rdata)
{
	...
	if (Psolar.elev >= Radiation::thresh_sun_elevation) {
		computePotentialRadiation(Psolar, Xdata.Albedo, Xdata.meta.position.getAltitude(), Atmosphere::stdAirPressure(Xdata.meta.position.getAltitude()), Mdata.rh, Mdata.ta, Rdata);
